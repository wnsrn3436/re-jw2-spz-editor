...
num1=argument0
while(string_copy(num1, 0, 1)="0"){num1=string_delete(num1, 1, 1)}

length=string_length(num1)
total=0

for(__i=0; __i!=length; __i+=1)
{
va1=1
...
if length-__i-2>=0{for(k=0; k!=length-__i-2; k+=1){va1=va1*16}}

if __i+1!=length{total+=16*va1*real(stringeses)}
